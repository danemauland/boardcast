...
import { KinesisVideoClient, CreateSignalingChannelCommand, DescribeSignalingChannelCommand, GetSignalingChannelEndpointCommand } from "@aws-sdk/client-kinesis-video";
...
export default function PresenterVideo({meeting}: {meeting: Meeting}) {
  ...
  return <div id='presenter-video-wrapper'>
    <div id="presenter-video">Placeholder while AWS resolves WebRTC bug, see <a href="https://github.com/aws/aws-sdk-js-v3/issues/3794"> Kinesis Video Client browser config issue #3794 </a></div>
  </div>
}